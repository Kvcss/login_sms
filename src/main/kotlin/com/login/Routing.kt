...
// Em modo dev, devolve o codigo de confirmacao no corpo do 202.
// NUNCA use isso em producao. Facilita a gravacao do video / testes.
...
fun Application.configureRouting() {
    routing {
        ...
        // PUT /users/{id}  { name, description, email }
        put("/users/{id}") {
        ...
        // GET /users/{id}  (auxiliar, util para testes e para o app)
        get("/users/{id}") {
            val id = call.parameters["id"]?.toIntOrNull()
